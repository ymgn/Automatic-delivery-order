...
class OrderListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_list" do
    assert_difference('OrderList.count') do
      post order_lists_url, params: { order_list: { account_id: @order_list.account_id, order_token: @order_list.order_token, sort_num: @order_list.sort_num } }
    end
  ...
  test "should update order_list" do
    patch order_list_url(@order_list), params: { order_list: { account_id: @order_list.account_id, order_token: @order_list.order_token, sort_num: @order_list.sort_num } }
